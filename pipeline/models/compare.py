...
from pipeline.models.utils import load_features, time_split
from pipeline.models.linear import train_lasso, train_ridge
...
def run_all() -> None:
    ...
    _save_top_movers(df)
    from pipeline.models.utils import get_feature_cols
