"""
[DEPRECATED] Riftbound Price Forecast — Streamlit Dashboard.

This Streamlit app has been retired. The platform has migrated to a React
frontend deployed on Vercel. All pipeline logic (scraper, model, export)
has been preserved in pipeline/ and continues to run via GitHub Actions.

Do not run: streamlit run src/dashboard/app.py
"""
...
from pipeline.dashboard.utils import load_features, load_model_comparison, load_prices, load_top_movers
